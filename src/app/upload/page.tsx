...
const mc2iResponse = {
  ...
  team: [
    { role: "Directeur de mission", name: "Pierre LAMBERT", exp: "14 ans énergie & data" },
    { role: "Manager senior", name: "Julie RENARD", exp: "Delivery & gouvernance data" },
    { role: "Architecte IoT", name: "Antoine MOREAU", exp: "Azure Synapse & IEC 61970" },
    { role: "Data Scientist", name: "Yasmine KADI", exp: "LSTM, XGBoost, prédiction énergie" },
    { role: "Expert jumeaux numériques", name: "Théo GARNIER", exp: "Digital Twin éolien & solaire" },
    { role: "Ingénieure maintenance prédictive", name: "Laure SIMON", exp: "Anomaly detection industrielle" },
    { role: "DevOps MLOps", name: "Nicolas DUPONT", exp: "Kubernetes, MLflow, CI/CD" },
    { role: "Consultante change", name: "Emma FORESTIER", exp: "Conduite du changement DSI" },
  ],
  modules: [
...
const similarAOs = [
  { id: "AO-2025-016", title: "Plateforme Data & IA pour actifs renouvelables — Assystem/Exodigo", client: "ENGIE SA", score: 92, sector: "Énergie et utilities", budget: "1,7M€", status: "lost" },
  { id: "AO-2025-005", title: "Transformation digitale des réseaux de distribution GRTgaz", client: "GRTgaz", score: 85, sector: "Énergie et utilities", budget: "2,1M€", status: "won" },
  { id: "AO-2025-017", title: "Plateforme Data & IA pour actifs renouvelables — Capgemini Invent", client: "ENGIE SA", score: 75, sector: "Énergie et utilities", budget: "1,8M€", status: "lost" },
];

const reusableExtracts = [
  {
    label: "Méthodologie EnergyDigital360",
    source: "MC2I-ENGIE-2025-089",
    preview: mc2iResponse.methodologyText,
  },
  {
    label: "Staffing type — projets data énergie",
    source: "MC2I-ENGIE-2025-089",
    preview: mc2iResponse.staffingText,
  },
  {
    label: "Éléments différenciants mc2i",
    source: "MC2I-ENGIE-2025-089",
    preview: mc2iResponse.differentiators,
  },
];
                ...
                {(step === "extracted" || step === "complete") && (
                  <motion.div key="done" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-3">
                    ...
                    <p className="text-base font-semibold">
                      {step === "complete" ? "Analyse complète" : "Extraction terminée"}
                    </p>
